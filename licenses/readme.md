...
<script type="text/javascript">
    ...
    $('#storymap').storymap({
        ...
        loader: true,
        flyto: false,
        credits: credits:  "<i class='material-icons' style='color: black; font-size: 10px;'>copyright</i> <a href='https://www.openstreetmap.org/copyright' target='blank'>OpenStreetMap contributors</a> <i class='material-icons' style='color: black; font-size: 10px;'><i class='material-icons' style='color: black; font-size: 10px;'>copyright</i> <a href='https://www.mapbox.com/about/maps/' target='blank'>Mapbox</a>add_location_alt</i> Template by Bo Zhao",
        scalebar: true,
        scrolldown: false,
        progressline: true,
        navwidget: true,
