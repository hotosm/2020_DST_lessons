...
(function ($) {
    ...
    $.fn.storymap = function (options) {
        ...
        var defaults = {
            ...
            createMap: function () {
                var map = L.map($('.storymap-map')[0], {zoomControl: false}).setView([23, -82], 7);
                // L.tileLayer('https://api.mapbox.com/styles/v1/hot/cjepk5hhz5o9w2rozqj353ut4.html?fresh=true&title=view&access_token=pk.eyJ1IjoiaG90IiwiYSI6IlBtUmNiR1kifQ.dCS1Eu9DIRNZGktc24IwtA').addTo(map);
                return map;
            }
        };      
